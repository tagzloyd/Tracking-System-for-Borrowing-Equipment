                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 text-center whitespace-nowrap">
                                                <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold
                                                    ${status === 'Returned' ? 'bg-green-100 text-green-800 border border-green-300' :
                                                    status === 'Borrowed' ? 'bg-yellow-100 text-yellow-800 border border-yellow-300' :
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-1 mt-2 justify-center">
                                                    {status === 'Deadline' && (
                                                        <button
                                                            className="px-2 py-1 text-xs rounded bg-green-200 text-green-800 hover:bg-green-300 border border-green-300 transition"
                                                            onClick={() => handleStatusUpdate(tracking.id, activeTab === 'students' ? 'student' : 'outsider', 'Returned')}
                                                        >
                                                            Mark Returned
                                                        </button>
                                                    )}
