    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="container mx-auto flex-1 flex flex-col gap-8 p-6">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          {/* Deadline */}
          <div className="bg-white p-6 rounded-2xl shadow-md border border-red-200 flex flex-col">
            <div className="flex items-center mb-3">
            ...
            <ul className="divide-y">
              {dashboardData.deadlines.length === 0 && (
                <li className="py-2 text-gray-400">No deadlines</li>
              )}
              {dashboardData.deadlines.map((activity, idx) => (
                <li key={idx} className="py-2 flex items-center">
                  <div>
                    <span className="font-medium text-gray-800">{activity.name}</span>
                    {renderUserType(activity.type)}
